...
test('la interfaz conserva el importJobId devuelto por cada preview',()=>{const ui=read('public/dashboard.js');assert.match(ui,/clientImportJobId=data\.importJobId/);assert.match(ui,/articleImportJobId=data\.importJobId/);});
