...
| MFA | Omisión, repetición TOTP o pérdida de la clave de cifrado | Escalada administrativa o bloqueo de cuentas | MFA obligatorio, límite de intentos, ventana temporal, step-up reciente, errores tipados y re-enrolamiento con revocación de sesiones | SPEC-003, runbook y pruebas MFA | No existen códigos de recuperación; el restablecimiento exige verificación humana independiente |
